...
function Chat() {
  return (
    <BaseLayout>
      ...
      <div className=" top-bar rounded-lg bg-white rounder-lg pb-5 mt-[310px] absolute lg:w-[710px] shadow-xl max-h-fit left-72 md:-ml-48 md:w-[740px] lg:ml-2 lg:mb-2 xl:mt-[400px] xl:w-[1120px]" />
